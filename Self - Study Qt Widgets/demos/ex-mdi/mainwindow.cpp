...
void MainWindow::updateWindowMenu()
{
    ...
    for (int i = 0; i < windows.size(); ++i) {
        ...
        connect(action, &QAction::triggered, windowMapper, static_cast<void (QSignalMapper::*)()>(&QSignalMapper::map));
...
void MainWindow::createMenus()
{
    ...
    connect(action, &QAction::triggered, this, &MainWindow::switchLayoutDirection);
